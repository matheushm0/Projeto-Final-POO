...
public class ViewUrna extends javax.swing.JFrame {
    ...
    public ViewUrna() {
        initComponents();
        DefaultTableModel cand = (DefaultTableModel) jTable1.getModel();
        
    }
    
    public void readJTable (String n){
        DefaultTableModel cand = (DefaultTableModel) jTable1.getModel();
        cand.setNumRows(0);
        CandidatoDAO dao = new CandidatoDAO();
        
        for (Candidato c: dao.readCandidato(n)){
            cand.addRow(new Object[]{
                c.getNomeCandidato(),
